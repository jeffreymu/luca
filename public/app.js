...
(() => {
  ...
  const platformResources={
    ...
    skills:{label:"Skills",get:()=>`/api/skills?workspaceId=${state.workspace.id}`,submit:()=>["/api/skills","POST"],actions:(i)=>[{label:"删除",path:`/api/skills/${i.id}`,method:"DELETE"}],help:"注入 Coding Agent 的 workspace instructions。",sample:{name:"Security",description:"Security review",instructions:"Check authentication boundaries",tools:["search_files"]}},
